          ...
          <div className="footer-container">
            ...
            <div className="column">
              <div className="Oasis-SocialMedia">
                <a href="http://twitter.com/OasisFarmSE1">
                  <img
                    ...
                    src="http://oasisfarmwaterloo.org/wp-content/uploads/2016/06/twitter_logo-e1466168243979.png"
                    alt="twitter_logo"
                    width="42"
                    height="43"
                  />
                ...
                <a href="https://www.facebook.com/OasisFarmWaterloo">
                  <img
                    class="alignnone size-full wp-image-68"
                    src="http://oasisfarmwaterloo.org/wp-content/uploads/2016/06/Facebook_logo-e1466168317268.png"
                    alt="Facebook_logo"
                    width="42"
                    height="43"
                  />
                ...
                <a href="https://www.instagram.com/oasisfarmwaterloo/">
                  <img
                    ...
                    src="http://oasisfarmwaterloo.org/wp-content/uploads/2019/01/app-icon2.png"
                    alt="instagram_logo"
                    width="42"
                    height="43"
                    hspace="17"
              ...
              <div className="Oasis-info">
                ...
                <a
                  className="Oasis-link"
                  href="https://goo.gl/maps/sBeSNjxu8uo"
                >
              ...
              <div className="Oasis-info">
                <b>Email. </b>
                <a className="Oasis-link" href="mailto:farm@oasiswaterloo.org">
                  farm@oasiswaterloo.org
                </a>
              </div>
            </div>
          </div>
